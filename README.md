...
Tableau Prep can do the following, Data clean, combine, aggregate, workflow, pivot, union, join, filter etc. This Feb I gave my feedback to Tableau Beta support, no rep and JVM performance issue for large data, suggestions like the user can turn off/on some calculations like data distribution etc
