...
#  },
  ...
  "customrecord_vehicle_selection" = {
    run_mode         = "fl",
    trigger_schedule = "cron(45 10 ? * THU *)",
    start_date       = "2022-01-01",
    end_date         = "2022-12-05"
  },
  "transaction_delta" = {
    run_mode         = "dl",
    trigger_schedule = "cron(52 16 * * ? *)",
    start_date       = "2022-03-02",
    end_date         = "2022-12-31"
  },
...
s3_temp_bucket_name  =  "ingestion-etl-development-temp"
...
zoho_trigger_schedule = ["cron(52 13 * * ? *)"]
...
kms_role_arn          = "arn:aws:kms:us-east-1:292923181097:key/b2b5d4f9-3d28-4c3e-96a5-9d0e0e6603bc"

// redshift connection vars
redshift_glue_connector = "redshift_glue_connector_reporting_development"
job_connections         = ["redshift_glue_connector_reporting_development"]
