...
def run_ingestion():
    ...
    if (query_result is not None):
        try:
            ...
            flatten_json_data = RawToDF.get_flatten_dayforce_employee_status_data(loads_json)
            ...
            if (not df.empty):
                ...
                processed_writer.redshift_copy(df=df, seq_number=seq_number, ingestion_date=ingestion_date, mode="overwrite", dtypes_col_list=dtypes_col_list, primary_keys=["employee_number","employment_status"])
